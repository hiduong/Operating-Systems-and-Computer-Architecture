...
int uPtable(PROC *p)
{
  ...
  u32 *pagetable = (u32 *)0x400000 + p->pid*0x4000;   // pagetable of proc at 4mb + pid* 16kb
  u32 entry = 0 | 0x412;       // 0x412;// AP=01 (Kmode R|W; Umode NO) domaian=0
  ...
  pagetable[2048] = 0x800000 + (p->pid-1)*0x100000 | 0xC32;
  pagetable[2049] = 0x1600000 + (p->pid-1)*0x100000 | 0xC32;
}
